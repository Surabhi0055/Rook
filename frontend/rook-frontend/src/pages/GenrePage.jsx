...
const SEED_CLUSTERS = {
  ...
  fiction: [
    ...
    },
    {
      ...
      similar: [
        ...
        "Actresses Anne Enright",
        "Intermezzo Sally Rooney",
      ],
    },
    {
      seed: "Where the Crawdads Sing",
      similar: [
  ...
  mystery: [
    ...
    {
      seed: "The Girl with the Dragon Tattoo",
      similar: [
        "The Girl Who Played with Fire",
        "The Girl Who Kicked the Hornets Nest",
        "The Girl in the Spiders Web",
        "Millennium series Larsson",
        "The Hypnotist Lars Kepler",
      ],
    },
    {
      seed: "Big Little Lies",
      similar: [
  ...
  romance: [
    ...
    },
    {
      ...
      similar: [
        ...
        "Voyager Gabaldon",
        "Drums of Autumn",
        "The Fiery Cross Gabaldon",
        "A Breath of Snow and Ashes",
      ],
    },
    {
      seed: "Pride and Prejudice",
      similar: [
  ...
  "science fiction": [
    ...
    {
      seed: "The Hitchhikers Guide to the Galaxy",
      similar: [
  ...
  horror: [
    ...
    },
    {
      ...
      similar: [
        ...
        "In the Tall Grass King",
        "White Is for Witching Helen Oyeyemi",
        "The Hacienda Isabel Canas",
      ],
    },
    {
      seed: "House of Leaves",
      similar: [
  ...
  biography: [
    ...
    {
      seed: "The Glass Castle",
      similar: [
        "A Tree Grows in Brooklyn Betty Smith",
        "This Boy Trevor Noah",
    ...
    },
    {
      ...
      similar: [
        ...
        "You Cant Touch My Hair Phoebe Robinson",
  ...
  history: [
    ...
    {
      seed: "The Diary of a Young Girl",
      similar: [
        "Night Elie Wiesel",
  ...
  "self-help": [
    ...
    {
      seed: "The 7 Habits of Highly Effective People",
      similar: [
  ...
  "young-adult": [
    ...
    {
      seed: "To All the Boys Ive Loved Before",
      similar: [
  ...
  crime: [
    ...
    {
      seed: "Tana French Dublin Murder",
      similar: [
  ...
  poetry: [
    ...
    },
    {
      ...
      similar: [
        ...
        "Everything I Know About Love Dolly Alderton poetry",
      ],
    },
    {
      seed: "Leaves of Grass",
      similar: [
        "Song of Myself Whitman",
        "Drum Taps Whitman",
        "The Complete Poems of Emily Dickinson",
        "Ariel Sylvia Plath",
        "The Bell Jar Plath prose",
      ],
    },
  ],
  ...
  "rom-com": [
    ...
    {
      seed: "Confessions of a Shopaholic",
      similar: [
    ...
    {
      seed: "Something Borrowed",
      similar: [
        "Something Blue Emily Giffin",
        "Heart of the Matter Emily Giffin",
        "Love the One Youre With Giffin",
  ...
  "horror-thriller": [
    ...
    {
      seed: "The Whisper Man",
      similar: [
        "The Butterfly Garden Dot Hutchison",
        "The Visitor Dot Hutchison",
        "No Good Deed Goldy Moldavsky",
        "The Last House on Needles Lane",
        "Watch Me Lisa Gardner",
      ],
    },
  ],
  ...
  "cozy-mystery": [
    ...
    {
      seed: "The Thursday Murder Club",
      similar: [
        "The Man Who Died Twice Richard Osman",
        "The Bullet That Missed Osman",
        "The Last Devil to Die Osman",
  ...
  "historical-fiction": [
    {
      seed: "All the Light We Cannot See",
      similar: [
    ...
    },
    {
      ...
      similar: [
        ...
        "The Mirror and the Light Mantel",
  ...
  "paranormal-romance": [
    {
      seed: "A Court of Thorns and Roses",
      similar: [
  ...
  "urban-fantasy": [
    {
      seed: "The Dresden Files",
      similar: [
        "Storm Front Jim Butcher",
        "Fool Moon Butcher",
        "Grave Peril Butcher",
        "Summer Knight Butcher",
  ...
  "chick-lit": [
    ...
    },
    {
      seed: "The Devil Wears Prada",
      similar: [
        "Revenge Wears Prada Weisberger",
        "The Singles Game Weisberger",
        "The Intern Lauren Layne",
        "Working Girl books",
  ...
  "spy-thriller": [
    {
      seed: "Tinker Tailor Soldier Spy",
      similar: [
    ...
    {
      seed: "The Day of the Jackal",
      similar: [
        "The Odessa File Frederick Forsyth",
        "The Dogs of War Forsyth",
...
function isClean(book, extraBlocklist = []) {
  const haystack = [
    ...
    .join(" ")
    .toLowerCase();
  return ![...GLOBAL_BLOCKLIST, ...extraBlocklist].some((w) =>
    ...
    const obs = new IntersectionObserver(
      (entries) => {
        if (entries[0].isIntersecting)
          setVisibleCount((c) => Math.min(c + PAGE_SIZE, books?.length || 0));
      },
      { threshold: 0.1 },
    );
  ...
  if (!books?.length)
    return (
      <div style={{ textAlign: "center", padding: "80px 0" }}>
        ...
        >
          Try a different genre or check your backend connection.
        </p>
      </div>
    );
      ...
      >
        {visible.map((b, i) => (
          <div
            ...
            onMouseEnter={(e) => {
              const c = e.currentTarget.querySelector(".gc-cover");
              if (c) c.style.transform = "scale(1.04)";
            }}
            onMouseLeave={(e) => {
              const c = e.currentTarget.querySelector(".gc-cover");
...
async function fetchGenreBooks(genre, signal, topN = 500) {
  ...
  // ── Tier 0: Similar-book expansion for every seed cluster ──
  const tier0Queries = clusters.flatMap((c) => c.similar);
  const tier0Results = await Promise.allSettled(
    tier0Queries
      .slice(0, 40)
      .map((term) =>
        tryFetch(
          `${API_BASE}/search?query=${encodeURIComponent(term)}&limit=30`,
          signal,
        ),
      ),
  );
  ...
  for (const r of tier0Results) {
    if (r.status === "fulfilled" && r.value)
      tier0Books.push(...extractBooks(r.value));
  }

  // ── Tier 1: Direct seed searches ──
  const tier1Queries = [
    ...(genre.searchTerms || []),
    ...(genre.seeds || []),
  ...
  const tier1Results = await Promise.allSettled(
    [...new Set(tier1Queries)]
      .slice(0, 20)
      .map((term) =>
        tryFetch(
          `${API_BASE}/search?query=${encodeURIComponent(term)}&limit=40`,
          signal,
        ),
      ),
  );
  ...
  for (const r of tier1Results) {
    if (r.status === "fulfilled" && r.value)
      tier1Books.push(...extractBooks(r.value));
  }
  ...
  const tier2Books = broad ? extractBooks(broad) : [];

  // ── Merge in tier order, dedup across all tiers, filter ──
  const merged = [...tier0Books, ...tier1Books, ...tier2Books];
  const finalBooks = filter(merged);

  console.log(
    `[GenrePage] ${finalBooks.length} books loaded for "${genre.label}"` +
      ` (t0:${filter(tier0Books).length} t1:${filter(tier1Books).length} t2:${filter(tier2Books).length})`,
  );
      ...
      >
        <div
          style={{
            ...
            background:
              "linear-gradient(135deg,#617891 0%,#25344f 50%,#25344f 100%)",
          }}
        >
          <p
            style={{
          ...
          >
            {loading ? (
              ...
              <span style={{ color: "#f09aaa" }}>{error}</span>
            ) : (
